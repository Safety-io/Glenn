        ...
        <div class="self-stretch w-full overflow-hidden lg:w-1/2 ">
            <div class=" overflow-hidden group">
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    <!-- Carousel wrapper -->
                    <div class="relative h-72 overflow-hidden rounded-t md:rounded-l-lg md:h-[27rem]">
                        <!-- Item 1 -->
                        @if ($house->image)
                            @foreach ($house->image as $image)
                                <livewire:house-image :image="$image"/>
                            @endforeach
                        @endif
                    </div>
                    <!-- Slider indicators -->
