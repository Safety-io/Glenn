...
<section class="bg-white">
    <div class="max-w-6xl px-4 mx-auto" x-data="{open:false}">
        <nav class="flex items-center justify-between py-2">
            <a href="{{ route('pages.index') }}" class="text-md font-medium leading-none  text-black">GNPropertie</a>
        ...
        <div class="absolute inset-0 z-10 h-screen p-3 text-gray-700 duration-500 transform shadow-md dark:bg-gray-800 bg-blue-50 w-80 lg:hidden lg:transform-none lg:relative"
            ...
            <div class="flex justify-between px-5 p-30 py-2">
                <a class="text-2xl font-bold dark:text-gray-400" href="{{ route('pages.index') }}">GNPropertie</a>
            ...
            <ul class="px-5 text-left mt-7">
                <li class="pb-3">
                    <a href="{{ route('pages.index') }}" class="text-sm text-gray-700 hover:text-blue-400 dark:text-gray-100">Home</a>
                </li>
                <li class="pb-3">
