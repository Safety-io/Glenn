    ...
    <form action="/search" method="GET" class="{{--  md:w-4/6 --}}w-full {{--max-w-6xl--}}{{-- mx-auto--}} px-6 py-8 bg-[#fffbff] text-[#1f1b16] rounded-md">
        ...
        <div class="flex flex-wrap -mx-3 md:justify-between">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <div class="relative">
                    <button type="reset"   class="    w-full bg-[#ffdad6] text-[#410002] hover:bg-[#ba1a1a] hover:text-[#ffffff] font-bold py-3 px-4 pr-8 rounded   focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">Filter Reset
                    </button>
                </div>
            </div>
            <div class="w-full md:w-1/2 px-3{{-- mb-6--}} md:mb-0">
                <div class="relative">
                    <button type="submit"   class="    w-full bg-[#d0ebc0] text-[#0c2006] hover:bg-[#4e6543] hover:text-[#ffffff] font-bold py-3 px-4 pr-8 rounded   focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">Filter Search</button>
                </div>
            </div>
        </div>
    </form>
