...
{{--    <div class="  px-4 lg:px-6 py-2.5 ">--}}
        <div class="w-full {{--mx-auto--}} mb-4 {{--sm:w-4/5--}} {{--sm:mb-0--}} flex justify-end mt-4 filter-none">
            <button id="filter-btn" type="button" class="flex items-center gap-x-2 py-2 px-4 justify-center border border-[#4e4539] rounded-lg bg-[#ffdeaa] {{--mb-5--}}" >
            ...
            <button id="filter-btn-close"  type="button" class="flex items-center gap-x-2  hidden py-2 px-4 justify-center border border-[#410002] rounded-lg bg-[#ffdad6] {{--mb-5--}}" >
